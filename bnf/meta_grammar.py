...
b = Grammar('meta-BNF')
b.root = ~b.suite
b.suite = (b.all_elements & b.root) >> emit_root

b.parse_definition = (ter('ID') & ter(':') & b.suite) >> emit_definition
b.element = ter('LIT') >> emit_lit_parser | ter('ID') >> emit_grammar_parser

b.multiline_root = ~b.multiline_suite
b.multiline_suite = ((b.all_elements | ter('NEWLINE')) & b.multiline_root) >> emit_root

b.opt_elem = (ter('[') & b.multiline_root & ter(']')) >> emit_opt_parser
b.group_elem = (ter('(') & b.multiline_root & ter(')')) >> emit_group_parser
...
b.all_elements = b.element | b.opt_elem | b.any_elem | b.group_elem | b.opt_elem | b.or_elem | b.one_plus_elem
