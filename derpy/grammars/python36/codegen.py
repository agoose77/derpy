"""
    ...
    Extension to ast that allow ast -> python36 code generation.

    :copyright: Copyright 2008 by Armin Ronacher.
    :license: BSD.
"""
from derpy.ast import *
from ..python36.ast import *
...
def to_source(node, indent_with=" " * 4, add_line_information=False):
    """This function can convert a node tree back into python36 sourcecode.
    This is useful for debugging purposes, especially if you're dealing with
    custom asts not generated by python36 itself.
...
class SourceGenerator(NodeVisitor):
    """This visitor is able to transform a well formed syntax tree into python36
